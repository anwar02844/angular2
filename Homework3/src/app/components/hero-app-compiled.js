...
var HeroApp = (function () {
    function HeroApp() {
        this.title = 'Children Heroes';
    }
    HeroApp = __decorate([router_1.RouteConfig([{ path: '/', component: hero_list_1.HeroList, as: 'Home' }, { path: '/edit/:id', component: hero_editor_1.HeroEditor, as: 'Edit' }]), angular2_1.Component({
        selector: 'heros-app',
        template: "\n        <h1>{{title}}</h1>\n<!--    <a [router-link]=\"['Home']\">Home</a>\n        <a [router-link]=\"['/Edit']\">Edit</a>-->\n        <router-outlet></router-outlet>",
        directives: [router_1.ROUTER_DIRECTIVES]
    }), __metadata('design:paramtypes', [])], HeroApp);
    return HeroApp;
})();
exports.HeroApp = HeroApp;
//# sourceMappingURL=hero-app.js.map

//# sourceMappingURL=hero-app-compiled.js.map